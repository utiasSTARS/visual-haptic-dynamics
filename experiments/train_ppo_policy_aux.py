...
import gym
from ppo import AuxPPO
from models import AuxActorCriticCNN
import torch 
import numpy as np
...
def train(args):
    ...
    if args.architecture == "mlp":
        raise NotImplementedError("Auxiliary task not available for mlp")
    elif args.architecture =="cnn":
        actor_critic = AuxActorCriticCNN(
            state_dim, 
            action_dim, 
            args.action_std, 
