...
def parse_vh_training_args():
    ...
    parser.add_argument('--use_img', type=str2bool, default=True, help='Encode image data')
    parser.add_argument('--dim_z_img', type=int, default=16, help='Latent state dimension of images')
    parser.add_argument('--use_haptic', type=str2bool, default=False, help='Encode haptic data')
    parser.add_argument('--dim_z_haptic', type=int, default=8, help='Latent state dimension of haptic')
    parser.add_argument('--use_arm', type=str2bool, default=False, help='Encode arm data')
