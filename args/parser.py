...
def parse_vh_training_args():
    ...
    parser.add_argument('--opt_n_step_pred_epochs', nargs='+', type=int, default=4096, required=True, help='Name of dataset to train on')
    parser.add_argument('--n_annealing_epoch', type=int, default=2048, help='Anneal KL loss up to this amount of epochs')
...
def parse_control_experiment_args():
    ...
    parser.add_argument('--n_worker', type=int, default=8,  help='Amount of workers for dataloading.')
