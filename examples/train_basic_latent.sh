                                        ...
                                        for bi_directional in ${bi_directionals[@]}; do
                                            for n_epoch in ${n_epochs[@]}; do
                                                python ../train.py \
                                                                    ...
                                                                    --n_batch $n_batch \
                                                                    --debug $debug \
                                                                    --comment "traj${traj_len}_base_latent_bn${batch_norm}_dyntype${dyn_net}_dyn${rnn_net}_framestacks${frame_stacks}_optvaebaseepochs${opt_vae_base_epoch}_lamrec${lam_rec}_lamkl${lam_kl}" \
                                                                    --device $device \
                                                                    --lr $lr \
